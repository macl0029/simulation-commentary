rm(list=ls())
# ------------------------------------------------------------
# Simulation for misclassified binary data with Se = 1, Sp < 1
# Code for commentary in Epidemiology
# Date, last update: 4/27/2026
# Author: MacLehose with assist from ChatGPT 5.4
# ------------------------------------------------------------
set.seed(20260424)
...
## inspect the simulated specificity draws
summary(sp_draw_store_fix)
summary(sp_draw_store_ran)
  
## Write the results table to a CSV file in  working directory
